...
public enum Reflector {
    ...
    public static <T> T invoke(Object any, String method, Object... input) {
        ...
        val i = getMethodRef(any instanceof Class ? (Class) any : any.getClass(), method, p);
    ...
    public static <T> T invoke(Object any, String method, Tuple<Class, Object>... input) {
        ...
        val i = getMethodRef(any instanceof Class ? (Class) any : any.getClass(), method, tuple.left().toArray(new Class[input.length]));
